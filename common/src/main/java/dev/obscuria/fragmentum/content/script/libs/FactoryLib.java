...
public class FactoryLib extends LuaWrapper<Object> {
    ...
    private static ResourceKey<?> resourceKeyOf(Object self, String registry, String identifier) {
        final var registryId = Identifier.parse(registry);
        final var locationId = Identifier.parse(identifier);
